        ...
        <div>
          {/* Header */}
              <div className="flex items-center justify-between mb-6">
                      <div>
                                <h1 className="text-xl font-bold text-gray-900">Pre-Trip Inspections</h1>h1>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-6">
                      <div className="bg-white rounded-xl border border-gray-200 p-4 shadow-sm">
                                <div className="flex items-center gap-2 mb-1">
                                            ...
                                            <span className="text-xs text-gray-500 uppercase tracking-wide font-medium">Total</span>span>
                                </div>div>
                                <p className="text-2xl font-bold text-gray-900">{total}</p>p>
                      </div>div>
                      <div className="bg-white rounded-xl border border-gray-200 p-4 shadow-sm">
                                <div className="flex items-center gap-2 mb-1">
                                            <CheckCircle className="w-4 h-4 text-green-500" />
                                            <span className="text-xs text-gray-500 uppercase tracking-wide font-medium">Passed</span>span>
                                </div>div>
                      ...
                      <div className="bg-white rounded-xl border border-red-100 p-4 shadow-sm">
                                <div className="flex items-center gap-2 mb-1">
                                            ...
                                            <span className="text-xs text-gray-500 uppercase tracking-wide font-medium">Defects</span>span>
                                </div>div>
                                <p className="text-2xl font-bold text-red-600">{defectCount}</p>p>
                      </div>div>
              </div>div>
                        ...
                        <div className="flex items-center gap-3 flex-shrink-0 ml-4">
                          {/* Item counts */}
                                  <div className="hidden sm:flex items-center gap-2 text-xs">
                                              <span className="text-green-600 font-medium">{passedItems.length} pass</span>span>
                                    {failedItems.length > 0 && (
                                        <span className="text-red-600 font-semibold">{failedItems.length} fail</span>span>
                                              )}
                                  </div>div>
                          {/* Overall badge */}
                                  <span className={cn(
                      ...
                      {/* Passed items */}
                              <div>
                                      ...
                                      <div key={idx} className="flex items-center gap-2 bg-white rounded-lg px-3 py-2 border border-gray-100 text-sm">
                                                        ...
                                                        <span className="text-gray-700 truncate">{item.name}</span>span>
                                      </div>div>
                                    ))}
                                          </div>div>
                              </div>div>
          ...
          <div className="bg-white rounded-xl border border-red-100 p-3 shadow-sm">
                <div className="flex items-start justify-between gap-3">
                        <div className="flex items-start gap-2 min-w-0">
                                  ...
                                  <div className="min-w-0">
                                              <p className="text-sm font-semibold text-gray-900">{item.name}</p>p>
                                    {item.notes && (
                          <p className="text-xs text-gray-500 mt-0.5 leading-relaxed">{item.notes}</p>p>
                                              )}
                                  </div>div>
                        </div>div>
                  {item.photo_url && (
