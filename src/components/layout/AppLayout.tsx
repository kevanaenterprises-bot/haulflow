...
import {
  Truck, LayoutDashboard, Users, Building2, FileText, LogOut, Menu,
  PackageOpen, ShieldCheck, Settings, Map, BarChart2, Wrench, CheckCircle,
  ClipboardList,
} from 'lucide-react';
...
export default function AppLayout({ activeTab, onTabChange, children }: AppLayoutProps) {
  ...
  // Detect if this is a demo session
  const isDemo = !!localStorage.getItem('hf_demo_expires_at');
  ...
  return (
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      ...
      {/* Kristy — floats on every tab of the dashboard/demo sandbox */}
      <InteractiveAvatar context={isDemo ? 'dashboard' : 'dashboard'} />
    </div>
  );
}
